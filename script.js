...
const SAMPLE_RECIPES = [
  ...
  ,
  {
    id: 'recipe_6',
    title: 'Швидке печиво',
    description: 'Просте домашнє печиво, яке готується за лічені хвилини з мінімуму інгредієнтів.',
    ...
    steps: [
      'Замішуємо тісто.',
      'Формуємо кульки діаметром 2 см.',
      'Вмокуємо одну сторону в цукор.',
      'Викладаємо на пергамент.',
      'Випікаємо 15 хвилин при 180°C.'
    ],
    createdAt: Date.now()
  },
  {
    ...
    description: 'Шоколадне печиво з красивими тріщинами та ніжною текстурою всередині.',
    ...
    steps: [
      'Яйця вбиваємо у цукор.',
      'Додаємо ванільний цукор, розпушувач, розтоплене масло, какао та борошно.',
      'Ставимо в холодильник на 30-40 хвилин.',
      'Формуємо кульки та обвалюємо в пудрі.',
      'Викладаємо на деко.',
      'Випікаємо 10-12 хвилин при 190°C.'
    ],
    createdAt: Date.now()
  },
  {
    id: 'recipe_8',
    title: 'Крафін',
    description: 'Ароматна здобна випічка з апельсиновою ноткою та сухофруктами.',
    ...
    steps: [
      'Готуємо опару з молока та дріжджів.',
      'Збиваємо яйця з цукром.',
      'Додаємо борошно, масло, цедру та сік.',
      'Замішуємо тісто і залишаємо на 1 годину.',
      'Розкатуємо, змащуємо маслом і додаємо сухофрукти.',
      'Формуємо та випікаємо 20-25 хвилин.'
    ],
    createdAt: Date.now()
  },
  {
    id: 'recipe_9',
    title: 'Мурашник',
    description: 'Класичний десерт з пісочного тіста та згущеного молока.',
    ...
    steps: [
      'Замісити тісто і охолодити.',
      'Натерти на деко та випекти.',
      'Змішати зі згущеним молоком.',
      'Сформувати десерт і охолодити.'
    ],
    createdAt: Date.now()
  },
  {
    id: 'recipe_10',
    title: 'Медовик',
    description: 'Ароматний медовий десерт з ніжною текстурою та горіхами.',
    ...
    steps: [
      ...
      'Додати яйця і мед.',
      'Замісити тісто.',
      'Випікати 25-30 хвилин при 180°C.'
    ],
    createdAt: Date.now()
  },
  {
    ...
    description: 'Освіжаючий пиріг з насиченим лимонним смаком.',
    ...
    steps: [
      'Замісити тісто і охолодити.',
      'Приготувати начинку.',
      'Викласти тісто у форму.',
      'Додати начинку.',
      'Випікати 30 хвилин при 200°C.'
    ],
    createdAt: Date.now()
  },
  {
    ...
    description: 'Ніжний пиріг зі свіжою малиною та кремовою заливкою.',
    image: 'https://www.nyamburg.ru/wp-content/uploads/malinovyy-pirog-v-dukhovke-full.jpg',
    category: 'Десерти',
    difficulty: 2,
    time: 60,
    ingredients: [
  ...
  },
  {
    ...
    description: 'М\'яке сирне печиво з цукровою скоринкою.',
    image: 'https://tse4.mm.bing.net/th/id/OIP.qtWc_B7xdtubG6sYCKA-MgAAAA?rs=1&pid=ImgDetMain&o=7&rm=3',
    category: 'Десерти',
    difficulty: 2,
    time: 40,
    ingredients: [
    ...
    steps: [
      'Замісити тісто.',
      'Розкатати та вирізати кружечки.',
      'Обваляти в цукрі.',
      'Скласти у форму.',
      'Випікати 15-20 хвилин при 200°C.'
    ],
    createdAt: Date.now()
  }
